  ...
  return (
    ...
    <div>
        ...
        <div className='flex items-center gap-2 sm:gap-3'>
            <button onClick={()=>navigate('/buy')}className='flex items-center gap-2 bg-blue-300 text-white px-4 py-1.5 sm:py-3 hover:scale-105 transition-all duration-700 rounded-full'>
