...
const Header = () => {
  ...
  return (
    ...
    viewport={{once:true}}>
        ...
        <motion.div className='text-stone-500 inline-flex text-center bg-white px-6 py-1 rounded-full border border-neutral-400'
      ...
      >
         ...
         className='mt-2 text-neutral-600 '>Generated image from imagex</motion.p>
    </motion.div>
  )
}
